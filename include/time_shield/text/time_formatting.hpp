...
#pragma once
#ifndef TIME_SHIELD_HEADER_TIME_SHIELD_TEXT_TIME_FORMATTING_HPP_INCLUDED
#define TIME_SHIELD_HEADER_TIME_SHIELD_TEXT_TIME_FORMATTING_HPP_INCLUDED
...
/// \{
    ...
    /// \brief Converts a timestamp to an ISO8601 date string.
    ///
    ...
    /// \brief Converts a timestamp to an ISO8601 time string.
    ///
    ...
    /// \brief Converts a timestamp to an ISO8601 UTC time string.
    ///
...
#endif // TIME_SHIELD_HEADER_TIME_SHIELD_TEXT_TIME_FORMATTING_HPP_INCLUDED
